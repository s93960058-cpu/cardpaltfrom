/*
  # Seed All Templates - 20 Templates

  This migration seeds the templates table with all 20 templates.
  It temporarily disables RLS to allow insertion.
*/
