-- Fix Templates Display Issue
-- Run this in Supabase SQL Editor to add all 20 templates

-- Step 1: Temporarily disable RLS to allow insertion
ALTER TABLE templates DISABLE ROW LEVEL SECURITY;

-- Step 2: Clear any existing templates
TRUNCATE TABLE templates CASCADE;

-- Step 3: Insert all 20 templates
...
-- Step 5: Verify - should return 20
